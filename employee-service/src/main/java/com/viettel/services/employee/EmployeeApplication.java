package com.viettel.services.employee;
...
import com.viettel.services.employee.model.Employee;
import com.viettel.services.employee.repository.EmployeeRepository;
...
public class EmployeeApplication {
	...
	public Docket swaggerPersonApi10() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
					.apis(RequestHandlerSelectors.basePackage("com.viettel.services.employee.controller"))
